...
// Checking quantities is from my previous Assignment 1 server
    app.post("/add_toCart", function (request, response) {
        ...
        // Ryan Tsuzaki helped me create a product_key to post and save that session's quantities to the Shopping Cart
...
// Ryan Tsuzaki helped me understand and work through this code to check quantity errors in the textbox when updating the cart
...
// Borrowed the res.clearCookie line from Kimberly Matutina 
    app.get("/logout", function (req, res) {
        // Ryan Tsuzaki helped me personalize the user's username
